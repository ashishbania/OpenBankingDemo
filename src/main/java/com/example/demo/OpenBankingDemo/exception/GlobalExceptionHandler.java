...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<Object> handleElementAlreadyExistsException(ElementAlreadyExistsException elementAlreadyExistsException, WebRequest request) {
        log.error("Element already exists", elementAlreadyExistsException);
        return buildErrorResponse(elementAlreadyExistsException, HttpStatus.NOT_ACCEPTABLE, request);
    }
